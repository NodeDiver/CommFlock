    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="announcements" className="space-y-6">
          <TabsList>
            <TabsTrigger value="announcements">{t('community.announcements')}</TabsTrigger>
                      ...
                      <div key={event.id} className="border rounded-lg p-4">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <span className="text-sm text-gray-500">
                            {event._count.registrations}/{event.capacity} attending
                          </span>
                          <Button size="sm" onClick={() => router.push(`/${slug}/events/${event.id}`)}>
                            View Details
                          </Button>
                        </div>
                      </div>
                    ...
                    {community.polls.map((poll) => (
                      <div key={poll.id} className="border rounded-lg p-4">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <Button size="sm" onClick={() => router.push(`/${slug}/polls/${poll.id}`)}>
                            {t('actions.vote')}
                          </Button>
                        </div>
                      </div>
