...
-- CreateEnum
CREATE TYPE "CommunityJoinPolicy" AS ENUM ('AUTO_JOIN', 'APPROVAL_REQUIRED', 'CLOSED');

-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('DRAFT', 'OPEN', 'CONFIRMED', 'CANCELLED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID_SIMULATED', 'REFUNDED', 'CANCELLED');
...
CREATE TABLE "Community" (
    ...
    "joinPolicy" "CommunityJoinPolicy" NOT NULL DEFAULT 'AUTO_JOIN',
...
CREATE TABLE "Payment" (
    ...
    "status" "PaymentStatus" NOT NULL DEFAULT 'PAID_SIMULATED',
    "providerMeta" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Poll" ADD CONSTRAINT "Poll_communityId_fkey" FOREIGN KEY ("communityId") REFERENCES "Community"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CrowdfundingGoal" ADD CONSTRAINT "CrowdfundingGoal_communityId_fkey" FOREIGN KEY ("communityId") REFERENCES "Community"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_crowdfundId_fkey" FOREIGN KEY ("crowdfundId") REFERENCES "CrowdfundingGoal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
